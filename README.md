...
# 📖 Simple Greeting Display Page

> Describe your project in 1 or 2 sentences.

Simple Greeting Display Page uses only html and css to a display a colored hello message to microverse.
...
- The linter works perfectly on the files
...
- Why is there no additional feature to it?

  - This is just a practice part

- Why does it not have Javascript?

  - Once the linter and other setup is all good js will be added 
...
This project is [MIT](https://github.com/Log-benjamin/Hello_Microverse/blob/main/LICENSE) licensed.
